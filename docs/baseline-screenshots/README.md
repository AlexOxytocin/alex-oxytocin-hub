# GOD-2 visual baseline

Captured from production on 2026-08-23 with headless Chrome. These images record the fragmented pre-migration site and are comparison evidence, not the target design.
