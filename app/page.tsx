      ...
      <section className="hero" id="top">
        ...
        <div className="hero-body">
          <ul className="hero-summary">
            <li>
              Опыт разработки, инфраструктуры и архитектуры помогает мне смотреть
              на задачу целиком — от идеи до внедрения.
            </li>
            <li>
              Индивидуально помогаю освоить ИИ на ваших задачах и выстроить подход
              для самостоятельной работы.
            </li>
            <li>
              Хороший инструмент должен быть понятным, надёжным и освобождать
              время, а не создавать новую ручную работу.
            </li>
            <li>
              Развиваю «Алло, Нейросеточная?» — тёплое и безопасное сообщество с
