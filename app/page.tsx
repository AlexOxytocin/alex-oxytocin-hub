      ...
      <header className="site-header">
        <a className="brand" href="#top" aria-label="Alex Oxytocin — на главную">
          <img
            ...
            src="/assets/alex-oxytocin-logo.svg?v=vector-wordmark-20260817"
            alt=""
            width="216"
            height="30"
          />
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-body">
          <ul className="hero-summary">
            <li>
              Смотрю на задачу целиком — от идеи и архитектуры до внедрения и
              ежедневной работы.
            </li>
            <li>
              Индивидуально обучаю работе с ИИ на ваших задачах, чтобы дальше вы
              могли применять его самостоятельно.
            </li>
            <li>
              Развиваю «Алло, Нейросеточная?» — тёплое и безопасное
              ИТ-сообщество профессионалов для взаимопомощи, совместных проектов
              и встреч онлайн и офлайн.
            </li>
          </ul>
        </div>
