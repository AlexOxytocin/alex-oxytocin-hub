    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-intro" id="about">
          ...
          <h1>
            Разрабатываю инструменты на основе ИИ, автоматизирую процессы и
            развиваю сообщество.
          </h1>
        </div>
        ...
        <div className="hero-body">
          <p>
            Проектирую и запускаю решения на основе ИИ: рабочие инструменты,
            автоматизацию повторяемых процессов и собственные продукты. Для меня
            важен практический результат — понятная система, которой можно
            пользоваться каждый день.
          </p>
          <p>
            Индивидуально обучаю работе с ИИ на реальных задачах. Вместе подбираем
            инструменты и выстраиваем подход, который можно применять
            самостоятельно после обучения.
          </p>
          <p>
            «Алло, Нейросеточная?» — важная часть того, что я делаю. Это
            сообщество профессионалов с тёплой и безопасной атмосферой: здесь
            можно попросить помощи, поделиться опытом, показать незаконченный
            проект и спокойно чего-то не знать. Мы проводим онлайн- и
            офлайн-встречи, запускаем совместные проекты и поддерживаем друг друга.
          </p>
